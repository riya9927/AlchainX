  ...
  const features = [
    {
      ...
      description: 'Transform your AI models into unique digital assets with verified performance metrics'
    },
    {
      icon: Shield,
      title: 'Smart Contract Security',
      description: 'Automated licensing, royalties, and usage rights enforced by blockchain technology'
    },
    {
      icon: Zap,
      title: 'BlockDAG Integration',
      description: 'Lightning-fast transactions and parallel execution on next-gen blockchain infrastructure'
    },
    {
      icon: TrendingUp,
      title: 'Dynamic Pricing',
      description: 'Model prices adjust based on real-time performance and demand analytics'
    }
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            ...
            <button className="flex items-center space-x-2 border border-white/20 text-white px-8 py-4 rounded-xl font-medium hover:bg-white/5 transition-all duration-200">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-white mb-2">8.9K</div>
